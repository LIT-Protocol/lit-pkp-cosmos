...
const cosmosPrivKeyToEthAddress = (privateKey) => __awaiter(void 0, void 0, void 0, function* () {
    const privkey = (0, encoding_1.fromHex)(privateKey);
    const keypair = yield crypto_1.Secp256k1.makeKeypair(privkey);
    (0, encoding_1.toHex)(keypair.pubkey); // 04b9e72dfd423bcf95b3801ac93f4392be5ff22143f9980eb78b3a860c4843bfd04829ae61cdba4b3b1978ac5fc64f5cc2f4350e35a108a9c9a92a81200a60cd64
    const compressed = crypto_1.Secp256k1.compressPubkey(keypair.pubkey);
    (0, encoding_1.toHex)(compressed); // 02b9e72dfd423bcf95b3801ac93f4392be5ff22143f9980eb78b3a860c4843bfd0
    const address = `0x${(0, encoding_1.toHex)((0, crypto_1.keccak256)(keypair.pubkey.slice(1)).slice(-20))}`; // 0x71cb05ee1b1f506ff321da3dac38f25c0c9ce6e1
    return address;
});
...
function testEthereumKeyToCosmos() {
    return __awaiter(this, void 0, void 0, function* () {
        const address = (0, litHelpers_1.pkpPubKeyToCosmosAddress)('0x04507302fc8404fe81260ed233a2d79f209f6789948b4fb31811fe9099bd0459ec8d7c893d10b65c8dd72a296084e8729dfeb13265c3d33d6b6fd6bad92616efad');
        console.log('address', address);
    });
}
// console.log('testEthereumKeyToCosmos', testEthereumKeyToCosmos())
function chrisDerivation(originalPubKey) {
    return __awaiter(this, void 0, void 0, function* () {
        let cleanedPubKey = originalPubKey;
        if (originalPubKey.startsWith('0x')) {
            cleanedPubKey = originalPubKey.slice(2);
        }
        let pubkey = secp256k1_1.default.publicKeyConvert(LitJsSdk.uint8arrayFromString(cleanedPubKey, "base16"), true);
        console.log("compressed pubkey: ", LitJsSdk.uint8arrayToString(pubkey, "base16"));
        ...
        const addressChainA = (0, amino_1.pubkeyToAddress)(pubkey, "cosmos");
